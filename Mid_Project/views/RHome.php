...
<button onclick="window.location.href='Discountcode.php'" style="font-family: 'Cooper Black'; font-size: 18px; width: 200px; height: 40px;  color:black;  background:orangered; border-color:black;">Verify discountcode</button>
<br>
<br>

<button onclick="window.location.href='RMeeting.php'" style="font-family: 'Cooper Black'; font-size: 18px; width: 200px; height: 40px;  color:black;  background:orangered; border-color:black;">Booking meetings</button>
<br>
<br>
